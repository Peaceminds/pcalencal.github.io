    ...
    data(){
        ...
        return {
            ...
            calendar2:{
                ...
                end:[2030,12,31], //可选结束日期
                selectsss(day, e){
                    that.dutydate.date.push(day);
                    that.dutydate.weekday.push(e);
                    console.log("...", that.dutydate);
                },
            },
        }
    },
